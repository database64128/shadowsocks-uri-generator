...
public sealed class BotConfig
{
    ...
    /// <returns>The <see cref="BotConfig"/> object.</returns>
    public static async Task<BotConfig> LoadAsync(CancellationToken cancellationToken = default)
    {
        var config = await FileHelper.LoadFromJsonFileAsync("TelegramBotConfig.json", BotConfigJsonSerializerContext.Default.BotConfig, cancellationToken);
    ...
    public Task SaveAsync(CancellationToken cancellationToken = default)
        => FileHelper.SaveToJsonFileAsync("TelegramBotConfig.json", this, BotConfigJsonSerializerContext.Default.BotConfig, cancellationToken);
